...
> **Canonical summary:** [`MgO-results.md`](MgO-results.md) · **Audit appendix:** [`MgO-audit.md`](MgO-audit.md)

A patched Quantum ESPRESSO 7.5 (`lmodelhf`) implements the true DD-RSH-CAM
...
| Strict DD-RSH-CAM gap (k 6x6x6, nqx 6x6x6, **production**) | **8.548 eV** (HOMO 6.270 / LUMO 14.817) |
...
Interpretation: the strict DD-RSH-CAM gap (8.55 eV) is in the paper's DD-RSH-CAM family
(8.32 eV) and far from approximate DD-HSE (5.23 eV). The +0.23 eV offset vs paper 8.32 is
documented in the convergence audit (k/nqx converged; setup/pipeline difference, not a kernel
bug). The functional overshoots experiment for MgO in the paper too.
